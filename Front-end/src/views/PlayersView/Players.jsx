  ...
  const Players = () => {
    ...
    console.log('📊 Estadísticas del jugador:', player.firstName, stats);
    console.log('🎯 Deporte:', sportName);
    ...
    if (sportName === 'Fútbol') {
      ...
      return [
        { label: 'Puntos', value: stats.points || stats.accumulatedPoints || 0 },
        { label: 'Rebotes', value: stats.rebounds || 0 },
        { label: 'Asistencias', value: stats.assists || 0 },
        { label: 'Partidos', value: stats.gamesPlayed || 0 },
        { label: 'Faltas', value: stats.fouls || 0 }
      ];
    } else if (sportName === 'Natación') {
      return [
        { label: 'Mejor Tiempo', value: stats.bestTime || 'N/A' },
        { label: 'Competiciones', value: stats.competitions || stats.gamesPlayed || 0 },
        { label: 'Metros', value: stats.metersSwum || 0 },
        { label: 'Victorias', value: stats.wins || 0 },
        { label: 'Estilo', value: stats.swimStyle || 'N/A' }
      ];
    } else if (sportName === 'Atletismo') {
      return [
        { label: 'Mejor Marca', value: stats.bestMark || 'N/A' },
        { label: 'Competiciones', value: stats.competitions || stats.gamesPlayed || 0 },
        { label: 'Podios', value: stats.podiums || 0 },
        { label: 'Récords', value: stats.records || 0 },
        { label: 'Distancia', value: stats.distance || 'N/A' }
      ];
    } else if (sportName === 'Rugby') {
      return [
        { label: 'Try', value: stats.tries || 0 },
        { label: 'Conversiones', value: stats.conversions || 0 },
        { label: 'Partidos', value: stats.gamesPlayed || 0 },
        { label: 'Tarj. Amarilla', value: stats.yellowCards || 0 },
        { label: 'Tarj. Roja', value: stats.redCards || 0 }
      ];
      ...
      return [
        ...
        { label: 'Asistencias', value: stats.assists || 0 },
        { label: 'Partidos', value: stats.gamesPlayed || 0 },
        { label: 'Penalties', value: stats.penalties || 0 },
        { label: 'Tarjetas', value: stats.cards || 0 }
      ];
      ...
      return [
        ...
        { label: 'Asistencias', value: stats.assists || 0 },
        { label: 'Partidos', value: stats.gamesPlayed || 0 },
        { label: 'Exclusiones', value: stats.exclusions || 0 },
        { label: 'Paradas', value: stats.saves || 0 }
      ];
    } else if (sportName === 'Bádminton') {
      return [
        { label: 'Partidos G', value: stats.gamesWon || 0 },
        { label: 'Partidos P', value: stats.gamesLost || 0 },
        { label: 'Sets G', value: stats.setsWon || 0 },
        { label: 'Puntos', value: stats.points || 0 },
        { label: 'Torneos', value: stats.tournaments || 0 }
      ];
    } else if (sportName === 'Pádel') {
      return [
        { label: 'Partidos G', value: stats.gamesWon || 0 },
        { label: 'Partidos P', value: stats.gamesLost || 0 },
        { label: 'Sets', value: stats.sets || 0 },
        { label: 'Puntos', value: stats.points || 0 },
        { label: 'Torneos', value: stats.tournaments || 0 }
      ];
    } else if (sportName === 'Ciclismo') {
      return [
        { label: 'Carreras', value: stats.races || 0 },
        { label: 'Victorias', value: stats.wins || 0 },
        { label: 'Km Recorridos', value: stats.kilometers || 0 },
        { label: 'Mejor Tiempo', value: stats.bestTime || 'N/A' },
        { label: 'Podios', value: stats.podiums || 0 }
      ];
    } else if (sportName === 'Gimnasia') {
      return [
        { label: 'Competiciones', value: stats.competitions || 0 },
        { label: 'Medallas', value: stats.medals || 0 },
        { label: 'Puntuación Max', value: stats.maxScore || 0 },
        { label: 'Aparatos', value: stats.apparatus || 'N/A' },
        { label: 'Nivel', value: stats.level || 'N/A' }
      ];
    } else {
      // Estadísticas generales para deportes no especificados
      return [
        { label: 'Partidos', value: stats.gamesPlayed || 0 },
        { label: 'Victorias', value: stats.gamesWon || 0 },
        { label: 'Derrotas', value: stats.gamesLost || 0 },
  ...
  {player.photo ? (
    <img 
      ...
      onError={(e) => {
        ...
        // Asegurarse de que el fallback sea visible
  ...
  <div 
    className={`player-avatar-fallback ${player.photo ? 'avatar-fallback-hidden' : ''}`}
  >
